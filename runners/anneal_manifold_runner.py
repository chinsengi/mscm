...
class AnnealMRunner():
        ...
        for epoch in range(self.config.training.n_epochs):
            for i, (X, y) in enumerate(dataloader):
                ...
                if self.config.training.algo == 'dsm':
                    ...
                    loss_sm = anneal_dsm_score_estimation(score, latent_X.detach(), labels, sigmas, self.config.training.anneal_power)
                    ...
                    # breakpoint()
                    rec_X = decoder(latent_X)
                    loss_sm = anneal_sliced_score_estimation_vr(score, latent_X.detach(), labels, sigmas,
                ...
                if step % 100 == 0:
                    ...
                    with torch.no_grad():
                        ...
                        test_dsm_loss = anneal_dsm_score_estimation(score, test_latent_X.detach(), test_labels, sigmas,
    ...
    def test(self):
        ...
        decoder.load_state_dict(states[2])
